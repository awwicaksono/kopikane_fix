		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<tbody>
					...
					<?php foreach($show as $key => $s) :?>
				<form action="<?php echo base_url('Data_super/ubah_status/'.$s['id_admin']); ?>" method="post">
			<tr>
				<td><?php echo $s['id_admin']?></td>
					<td><?php echo $s['username_admin']; ?></td>
					<?php if($s['nama_cafe']==NULL) { ?>
						<td>Tidak ada cafe</td>
					<?php } else { ?>
						<td><?php echo $s['nama_cafe'];?></td>
					<?php } ?>
					<td><?php echo $s['email_admin']; ?></td>
					<td><?php echo $s['password_admin']; ?></td>
					<td><?php echo $s['status']?></td>

					<td>
						<?php if($s['status'] == 'Y') { ?>
							<button type="submit" name="new_status" class="btn-warning" value="N">Nonaktfikan User</button>
						<?php } else { ?>
							<button type="submit" name="new_status" class="btn-warning" value="Y">Aktifkan User</button>
						<?php } ?>
					</td>
			</tr> 
				</form>
